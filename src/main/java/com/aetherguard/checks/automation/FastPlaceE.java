...
public class FastPlaceE extends AutomationCheck {
    public FastPlaceE(AetherGuard plugin, String category, String name, String type) { super(plugin, category, name, type); }
