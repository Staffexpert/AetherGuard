...
public class FastPlaceA extends AutomationCheck {
    public FastPlaceA(AetherGuard plugin, String category, String name, String type) { super(plugin, category, name, type); }
