...
public class AutoClickerB extends AutomationCheck {
    public AutoClickerB(AetherGuard plugin, String category, String name, String type) { super(plugin, category, name, type); }
