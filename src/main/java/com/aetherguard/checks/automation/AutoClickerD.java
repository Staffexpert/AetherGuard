...
public class AutoClickerD extends AutomationCheck {
    public AutoClickerD(AetherGuard plugin, String category, String name, String type) { super(plugin, category, name, type); }
