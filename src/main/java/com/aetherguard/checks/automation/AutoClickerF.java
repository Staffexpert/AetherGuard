...
public class AutoClickerF extends AutomationCheck {
    public AutoClickerF(AetherGuard plugin, String category, String name, String type) { super(plugin, category, name, type); }
