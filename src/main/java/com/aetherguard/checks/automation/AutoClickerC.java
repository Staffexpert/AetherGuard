...
public class AutoClickerC extends AutomationCheck {
    public AutoClickerC(AetherGuard plugin, String category, String name, String type) { super(plugin, category, name, type); }
