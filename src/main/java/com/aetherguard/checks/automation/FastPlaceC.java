...
public class FastPlaceC extends AutomationCheck {
    public FastPlaceC(AetherGuard plugin, String category, String name, String type) { super(plugin, category, name, type); }
